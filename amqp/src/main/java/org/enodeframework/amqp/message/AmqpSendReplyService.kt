 ...
 */
class AmqpSendReplyService(
    private val amqpProducerHolder: AmqpProducerHolder,
    ...
    override fun send(message: ReplyMessage): CompletableFuture<SendMessageResult> {
        ...
        val queueMessage = message.asPartQueueMessage()
        queueMessage.body = serializeService.serializeBytes(genericReplyMessage)
        queueMessage.tag = genericReplyMessage.asTag()
