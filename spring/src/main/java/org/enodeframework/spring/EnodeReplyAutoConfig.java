...
public class EnodeReplyAutoConfig {
    ...
    static class KafkaReply {
        ...
        @ConditionalOnMissingBean(KafkaMessageListener.class)
    ...
    static class PulsarReply {
        ...
        @ConditionalOnMissingBean(PulsarMessageListener.class)
    ...
    static class AmqpReply {
        ...
        @ConditionalOnMissingBean(AmqpMessageListener.class)
