...
public class MysqlEventStore extends JDBCEventStore {
    ...
    public MysqlEventStore(DataSource dataSource, IEventSerializer eventSerializer, ISerializeService serializeService) {
        super(dataSource, eventSerializer, serializeService);
    }

    public MysqlEventStore(DataSource dataSource, DBConfiguration setting, IEventSerializer eventSerializer, ISerializeService serializeService) {
