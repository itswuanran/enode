package com.enodeframework.common.remoting.protocol;

import com.enodeframework.common.remoting.CommandCustomHeader;
import com.enodeframework.common.remoting.annotation.CFNotNull;
...
public class RemotingCommand {
    ...
    private byte[] headerEncode() {
        ...
        return RemotingCommandSerialable.encodeHeader(this);
    }
    ...
    public String toString() {
        return "RemotingCommand [code=" + code + ", opaque=" + opaque + ", flag(B)="
